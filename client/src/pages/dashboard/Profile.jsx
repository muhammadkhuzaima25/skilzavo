...
export default function Profile() {
  ...
  const [profInfo, setProfInfo] = useState({
    skills: (() => {
      ...
      try { return JSON.parse(user.skills) } catch { return user.skills.split(',').map(s => s.trim()).filter(Boolean) }
    })(),
    skillInput: '',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center h-fit">
            <div className="w-[120px] h-[120px] rounded-full bg-[#0A7C72] flex items-center justify-center overflow-hidden mx-auto">
              {profilePic ? (
            ...
            <button
              ...
              disabled={uploading}
              className="w-full bg-[#0A7C72] text-white rounded-lg py-2 text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#065F55] disabled:opacity-50"
            >
              <Camera size={16} />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1">
                      ...
                      <input
                        ...
                        disabled
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm bg-gray-50 text-gray-500 cursor-not-allowed focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                      />
                    </div>
                    <div className="col-span-2">
                    ...
                    <div className="col-span-2">
                      ...
                      <textarea
                        ...
                        rows={4}
                        maxLength={500}
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 resize-none"
                      />
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                      />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="0"
                          min="0"
                          className="w-full border border-gray-200 rounded-lg pl-8 pr-3 py-2 text-sm focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                        />
                      </div>
                      {Number(profInfo.hourlyRate) > 0 && (
                        <p className="text-xs text-gray-400 mt-1">= PKR {Number(profInfo.hourlyRate) * 278}</p>
                      )}
                    </div>
                  </div>
              ...
              {activeTab === 2 && (
                <div>
                  <form onSubmit={submitPassword} className="space-y-4">
                      ...
                      <div key={key}>
                        ...
                        <div className="relative">
                          <input
                            ...
                            placeholder="••••••••"
                            className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm pr-10 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                          />
                          <button
                            type="button"
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <div className="flex-1 h-2 rounded-full bg-gray-200 overflow-hidden">
                            <div className={`h-full rounded-full transition-all ${passStrength.color}`} style={{ width: passStrength.width }} />
                          </div>
                          {passStrength.label && (
                            <span className={`text-xs font-medium ${
                              passStrength.label === 'Weak' ? 'text-red-500' : passStrength.label === 'Medium' ? 'text-orange-500' : 'text-green-500'
                            }`}>
                              {passStrength.label}
                            </span>
                          )}
                    ...
                    <button
                      type="submit"
                      className="bg-teal-700 text-white px-6 py-2 rounded-lg text-sm hover:bg-teal-800"
                    >
                      Update Password
                    </button>
                  </form>
                  ...
                  <div className="mt-6 border border-red-200 rounded-xl p-4">
                    <h4 className="text-red-600 font-semibold text-sm">Danger Zone</h4>
                    <p className="text-sm text-gray-500 mt-1">Permanently delete your account and all data. This cannot be undone.</p>
                    <button
                      type="button"
                      className="mt-3 border border-red-500 text-red-500 hover:bg-red-50 px-4 py-2 rounded-lg text-sm"
                    >
                      Delete Account
                    </button>
                  </div>

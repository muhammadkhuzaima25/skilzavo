...
import Inbox from '../components/provider/Messages';
...
const ProviderDashboard = () => {
  ...
  return (
      ...
      <ProviderSidebar activeTab={activeTab} onTabChange={setActiveTab} />
      ...
      <div className="flex-1 lg:ml-0 pb-20 lg:pb-0 relative">
        <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
          ...
          {activeTab === 'requests' && <Requests onRequestUpdate={() => fetchServices()} />}

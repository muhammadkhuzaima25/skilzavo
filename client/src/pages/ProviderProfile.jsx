      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 md:p-8 mb-6">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            <div className="w-24 h-24 rounded-full bg-primary-50 flex items-center justify-center text-primary font-bold text-3xl">
              ...
              {provider.skills?.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-3 justify-center md:justify-start">
                  {provider.skills.map((skill, i) => (
                    <span key={i} className="bg-primary-50 text-primary-dark text-xs px-3 py-1 rounded-full font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <div className="space-y-3 text-sm">
                {provider.experience && (
                  <div>
                    ...
                    <p className="font-medium text-gray-700">{provider.experience}</p>
                  </div>
                )}
                {provider.hourlyRate > 0 && (
                  <div>
                    <p className="text-gray-400">Hourly Rate</p>
                    <p className="font-medium text-gray-700">${provider.hourlyRate}/hr</p>
                  </div>
                )}
                <div>
